...
flowchart LR
    ...
    Staff(["🧍<br/>Laboratory Staff"])
    Requester(["🧍<br/>Requester / Viewer"])
    ...
    classDef actor fill:#fff7e6,stroke:#6b4f2a,stroke-width:2px,color:#2d241b;
    class Admin,Staff,Requester actor;
```
